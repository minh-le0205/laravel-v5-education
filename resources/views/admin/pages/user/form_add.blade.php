@php
    ...
    $inputHiddenAvatar = Form::hidden('avatar_current', isset($item['avatar']) ? $item['avatar'] : null);
    ...
    $elements = [
        ...
        [
            ...
            'avatar' => !empty($item['id'])
                ? Template::showItemThumb($controllerName, $item['avatar'], $item['name'])
                : null,
            'type' => 'avatar',
        ],
        [
            'element' =>
                $inputHiddenID .
                $inputHiddenAvatar .
                Form::submit('Save', ['class' => 'btn btn-success', 'name' => 'taskAdd']),
            'type' => 'btn-submit',
        ],
    ];
@endphp
